...
std::vector<double> segment_end_times_;        // Stores accumulated end time of each segment
std::vector<Eigen::Vector3d> segment_end_positions_; // Stores end position (xT) of each segment
...
public:
    ...
    double getYaw(double t); // Changed parameter name from theta to t for clarity
